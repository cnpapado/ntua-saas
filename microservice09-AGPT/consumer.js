...
const run = async () => {
  ...
  await consumer.run({
    eachMessage: async ({ topic, partition, message }) => {
      ...
      if(msg.DateTime !== undefined && msg.AreaTypeCode === 'CTY'){
       ...
       data = {
            ...
            "MapCode" : msg.MapCode,
            "ProductionType":msg.ProductionType,
            "ActualGenerationOutput": msg.ActualGenerationOutput,
            "UpdateTime" : msg.UpdateTime
        }
        console.log(data)
        //console.log(data.DateTime);
        await agpt.doc(msg.DateTime.concat('-',msg.MapCode).concat('-',msg.ProductionType.replace(/\//g, ''))).set(data);
